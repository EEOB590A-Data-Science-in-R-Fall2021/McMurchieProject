...
#library(knitr)
#library(formatR)
library(RRPP) #factorial manova uses this but changes some names here as well
library(geomorph) #factorial manova uses this but changes some names here as well
library(tidyverse) 
